...
class DemoAppgcl extends StatefulWidget {
  @override
  _DemoAppState createState() => _DemoAppState();
}

class _DemoAppState extends State<DemoAppgcl> {
  ...
  callAPI() async {
    ytResult = await ytApi.getPlaylistItems("PLWFBUvXxWM8DhSdLE_eKNx0-CEKHA3VOU");
    setState(() {});
  }
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (_)=> VideoScreen(id: YoutubePlayer.convertUrlToId(ytResult[index].url).toString())));},
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFF4A4143),
                          ), 
